...
{
    internal class CandidateSignUp
    {
        ...
        {
            Browser.GetElement("//*[@id=\"content\"]/div[1]/a").Click();
            Browser.GetElement(
        ...
        private void SignUp()
        {
            ...
            Browser.GetElement("//*[@id=\"content\"]/ui-view/div/div[2]/ui-view/div/form/div/div[2]/div[1]/div[1]/input")
                .Clear();
            Browser.GetElement("//*[@id=\"content\"]/ui-view/div/div[2]/ui-view/div/form/div/div[2]/div[1]/div[1]/input")
                .SendKeys("Selenium");
            Browser.GetElement("//*[@id=\"content\"]/ui-view/div/div[2]/ui-view/div/form/div/div[2]/div[3]/div[1]/input")
                .Clear();
            Browser.GetElement("//*[@id=\"content\"]/ui-view/div/div[2]/ui-view/div/form/div/div[2]/div[3]/div[1]/input")
                .SendKeys(Email);
            Browser.GetElement("//*[@id=\"content\"]/ui-view/div/div[2]/ui-view/div/form/div/div[2]/div[4]/div[1]/input")
                .SendKeys("Popov2010");
